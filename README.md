...
Each Scholar attempt has an 8-minute limit and is retried up to three times. Data-fetch workflows also have a 45-minute crawler limit, so a blocked request fails visibly instead of consuming the full GitHub Actions job limit.
